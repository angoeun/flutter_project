...
Future<void> information2() async{
...
class InputSample2 extends StatefulWidget {
  @override
  State createState() => InputSample2State();
}

class InputSample2State extends State<InputSample2> {
            ...
            children: <Widget>[
              Container(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(hintText: '변경할 닉네임을 입력해 주세요.'),
                  onChanged: (value1) {
                    setState((){
                      nickname = value1;
                    });
              ...
              Container(
                child: TextFormField(
                  ...
                  style: TextStyle(fontSize: 16, color: CustomColors.firebaseGrey),
                  textAlign: TextAlign.center,
                  decoration: InputDecoration(hintText: '변경할 지역을 입력해 주세요.'),
                  onChanged: (value2) {
                    setState((){
                      area = value2;
                    });
              ...
              Container(
                child: TextFormField(
                  ...
                  style: TextStyle(fontSize: 16, color: CustomColors.firebaseGrey),
                  textAlign: TextAlign.center,
                  decoration: InputDecoration(hintText: '변경할 자기소개를 입력해 주세요.'),
                  onChanged: (value3) {
                    setState((){
                      aboutMe = value3;
                    });
